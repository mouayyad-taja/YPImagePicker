...
public class YPFullVideoFiltersVC: UIViewController, IsMediaFilterVC {
    ...
    public class func initWith(video: YPMediaVideo,
                               isFromSelectionVC: Bool) -> YPFullVideoFiltersVC {
        let vc = YPFullVideoFiltersVC(nibName: "YPFullVideoFiltersVC", bundle: Bundle(for: YPFullVideoFiltersVC.self))
        vc.inputVideo = video
...
extension YPFullVideoFiltersVC: TrimmerViewDelegate {
...
extension YPFullVideoFiltersVC: ThumbSelectorViewDelegate {
